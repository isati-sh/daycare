  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <div className="max-w-md w-full bg-white shadow rounded-lg p-6">
        <h2 className="text-xl font-semibold text-red-600 mb-2">Announcements Error</h2>
        <p className="text-sm text-gray-600 mb-4">An error occurred while loading announcements.</p>
        {error.message && (
