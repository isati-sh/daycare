            ...
            {staffMembers.map((staff, index) => (
              <Card key={index} className="hover:shadow-lg transition-shadow">
                <CardHeader className="text-center">
                  ...
                  <CardDescription>
                    <Badge variant="secondary" className="mb-2">{staff.role}</Badge>
      ...
      <section className="py-20 bg-primary-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8 text-center">
            ...
            <div>
              <div className="text-4xl font-bold mb-2">8:1</div>
              <div className="text-primary-100">Student-Teacher Ratio</div>
            </div>
            <div>
              <div className="text-4xl font-bold mb-2">100%</div>
              <div className="text-primary-100">Licensed & Insured</div>
            </div>
          </div>
        </div>
      </section>
