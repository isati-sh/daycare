...
export const metadata: Metadata = {
  title: 'Little Learners Daycare – Quality Childcare You Can Trust',
  description: 'Daily reports, activities, attendance tracking, and parent communication in one modern daycare platform. Quality childcare for ages 6 weeks to 5 years.',
  keywords: 'daycare, childcare, preschool, early education, kids, learning, parent portal, daily reports, attendance tracking',
  openGraph: {
    title: 'Little Learners Daycare – Quality Childcare You Can Trust',
    description: 'Daily reports, activities, attendance tracking, and parent communication in one modern daycare platform.',
