...
export default function ParentReportsPage() {
  ...
  const dummyReports: Report[] = [
    ...
    {
      id: '3',
      title: 'Monthly Assessment - Emma Johnson',
      type: 'monthly',
      child_name: 'Emma Johnson',
      date: '2024-03-01',
      status: 'sent',
      content: 'Emma has made excellent progress in her motor skills and social interactions this month.',
      activities_completed: 120,
      attendance_rate: 95,
      mood_summary: 'Calm and content, responds well to routine',
      notes_for_parents: 'Emma is developing well and enjoys creative activities. She has formed strong friendships with her classmates.',
      teacher_name: 'Sarah Johnson'
    }
  ]
  ...
  const filteredReports = reports.filter(report => {
    ...
    const matchesChild = selectedChild === 'all' || report.child_name === selectedChild
    return matchesDate && matchesType && matchesChild
  })
              ...
              <Card key={report.id} className="hover:shadow-md transition-shadow">
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <CardDescription className="mt-1">
                        {report.child_name} • {report.teacher_name} • {new Date(report.date).toLocaleDateString()}
                      </CardDescription>
                    </div>
                ...
                <CardContent className="space-y-4">
                  ...
                  {report.notes_for_parents && (
                    <div>
                      <h4 className="text-sm font-medium text-gray-700 mb-2">Notes from Teacher:</h4>
